        ...
        <div class="col-md-8 header">
            ...
            <ul>
                ...
                <li>
                    ...
                    if (strlen($_SESSION['uid']==0)) {
                        ...
                        echo "<span class='fa fa-unlock-alt' aria-hidden='true'></span> Sign In </a>";
                    }
                    else{

                        echo '<a href="logout.php">';
                        echo '<span class="fa fa-unlock-alt" aria-hidden="true"></span> Sign Out </a>';
                ...
                <li>
                    ...
                    if (strlen($_SESSION['uid']==0)) {
                        ...
                        echo "<span class='fa fa-pencil-square-o' aria - hidden = 'true' ></span > Sign Up </a >";
                    }
                    else{

                        echo '<a href="account.php">';
                        echo "<h4 style='color: blue; text-align: center;'>Welcome $name! </h4></a>";
            ...
            <div class="agileits_search">
                <form action="sresults.php" method="post">
                    <input name="search_text" id="search_text" type="search" placeholder="How can we help you today?" required="">
                    <button type="submit" class="btn btn-default" aria-label="Left Align" name="bttn">
            ...
            <div class="modal-body modal-body-sub_agile">
                ...
                <div class="modal_body_left modal_body_left1">
                    ...
                    <form action="signup.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="styled-input agile-styled-input-top">
                            <input type="text" placeholder="First Name" name="fname" value="" pattern="[A-Za-z]{1,32}" required="">
                        </div>
                        <div class="styled-input">
                            <input type="text" placeholder="Last Name" name="lname" pattern="[A-Za-z]{1,32}" required="">
                        </div>
                        <div class="styled-input">
                            <input type="email" placeholder="E-mail" name="email" required="">
                        </div>
                        <div class="styled-input">
                            <input type="tel" placeholder="Phone" name="phone" pattern="[0-9]{10}" required="">
                        </div>
                        <div class="styled-input">
                            <input type="password" placeholder="Password" name="password" required="">
                        </div>
